...
def test_console_helper(self):
    """
    Test the built-in helper method of the console,
    which is one of the default commands provided by cmd.Cmd.
    """
    ...
    def test_console_quit(self):
        """
        Testing the console's built-in helper method, 
        which is one of the default commands included with cmd.Cmd.
        """
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_console_EOF(self):
        """
        Testing a core console method that is part of the
        default set of commands provided by cmd.Cmd.
        """
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_create_and_show_on_all_instances(self):
        """
        Testing the functionality of the create and show commands 
        by creating instances of BaseModel, User, State, City,
    ...
    def test_userall_command_output(self):
        """
        This test method confirms that the user.all 
